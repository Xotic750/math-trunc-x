...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["mathTruncX"] = factory();
	else
		root["mathTruncX"] = factory();
})((function () {
  'use strict';
...
// CONCATENATED MODULE: ./dist/math-trunc-x.esm.js
...
var math_trunc_x_esm_trunc = function trunc(value) {
  var number = to_number_x_esm(value);
  return number < 0 ? ceil(number) : floor(number);
};

/* harmony default export */ var math_trunc_x_esm = __webpack_exports__["default"] = (math_trunc_x_esm_trunc);
...
//# sourceMappingURL=math-trunc-x.js.map